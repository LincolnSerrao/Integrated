...
STAGING_DIR = Path(os.environ.get("SANDBOX_STAGING_DIR", "/tmp/cybershield/staging"))
...
def get_scan_config() -> dict[str, Any]:
    return {
        ...
        "message": (
            "KDE Plasma Monitor active: Watching ~/Downloads and removable media. "
            f"Manual uploads staged via {STAGING_DIR}."
        ),
    }
